...
/**
 * <strong>Title : UrlEncoderUtils</strong><br>
 * <strong>Description : 判断url是否被encode过</strong><br>
 * <strong>Create on : 2019-10-23</strong><br>
 * <strong>Modify on : 2019-10-23</strong><br>
...
public class UrlEncoderUtils {
    ...
    public static void main ( String[] args ) {
        System.out.println(UrlEncoderUtils.hasUrlEncoded( "cq+DdHFotno=" ));
    }
}
