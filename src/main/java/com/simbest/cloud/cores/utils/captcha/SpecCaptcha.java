 ...
 */
package com.simbest.cloud.cores.utils.captcha;

import com.simbest.cloud.cores.constants.ApplicationConstants;
import com.simbest.cloud.cores.utils.AppSessionUtil;
...
public class SpecCaptcha extends Captcha {
     ...
     */
    @Override
    public void out(HttpServletRequest request, OutputStream out) {
        graphicsImage(request, alphas(), out);
    }
     ...
     * @param out  输出流
     */
    private boolean graphicsImage(HttpServletRequest request, char[] strs, OutputStream out) {
        boolean ok = false;
        try {
