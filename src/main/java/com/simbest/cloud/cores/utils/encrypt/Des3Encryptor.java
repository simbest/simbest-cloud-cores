...
public class Des3Encryptor extends AbstractEncryptor {
    ...
    public static void main(String[] args) throws Exception {
        ...
        log.debug(encryptor.encrypt("hadmin"));
        log.debug("###########################");
        log.debug(encryptor.decrypt(encryptor.encrypt("hadmin")));
    }
    ...
    protected String encryptSource(String source) {
        ...
        try {
            ...
            byte[] encryptData = cipher.doFinal(source.getBytes(ApplicationConstants.UTF_8));
    ...
    protected String decryptCode(String code) {
        ...
        try {
            ...
            result =  new String(decryptData, ApplicationConstants.UTF_8);
        } catch (Exception e) {
            log.warn("解密【{}】失败", code);
