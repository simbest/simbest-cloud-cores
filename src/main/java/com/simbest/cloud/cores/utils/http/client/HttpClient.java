...
public class HttpClient {
    ...
    /**
     * @see com.simbest.cloud.cores.config.RestClientConfiguration
     */
    @Autowired
    ...
    public static PostRequest post(String url) {
        ...
        postRequest.setAppFileUtil(httpClient.appFileUtil);
        return postRequest;
    }
    ...
    public static TextBodyRequest textBody(String url) {
        ...
        textBodyRequest.setAppFileUtil(httpClient.appFileUtil);
        return textBodyRequest;
    }
