...
//                 }).toFormatter();
//
//    public static final java.time.format.DateTimeFormatter dfDate = java.time.format.DateTimeFormatter.ofPattern(datePattern1);
//    public static final java.time.format.DateTimeFormatter dfDateTime = java.time.format.DateTimeFormatter.ofPattern(timestampPattern1);
//    public static final java.time.format.DateTimeFormatter dfDateTimestamp = java.time.format.DateTimeFormatter.ofPattern(timestampPattern2);
//
//    private DateUtil() {
//        //not called
//    }
...
//
//		System.out.println(dateStrFormaterLocalDate("2019-09-19"));
//		System.out.println(dateStrFormaterLocalDateTime("2014-01-02 11:32:55",LocalDateTimeFormatterEnum.DATE_TIME_FORMATTER.getType()));
//		System.out.println(dateStrFormaterLocalDateTime("2014-01-02 14:32:55.444",LocalDateTimeFormatterEnum.DATE_TIME_STAMP_FORMATTER.getType()));
//    }
//
//    /**
//     *
...
//    }
//
//	public static LocalDate dateStrFormaterLocalDate(String dateStr){
//    	LocalDate localDate = LocalDate.parse(dateStr,dfDate);
//		return localDate;
//	}
//
//	public static LocalDateTime dateStrFormaterLocalDateTime(String dateTimeStr,String type){
//		return LocalDateTime.parse(dateTimeStr,LocalDateTimeFormatterEnum.getByTypeWithFormatter(type));
//	}
//
//	/**
...
//	}
//
//	public enum LocalDateTimeFormatterEnum{
//
//		DATE_TIME_FORMATTER("dateTime",dfDateTime),DATE_TIME_STAMP_FORMATTER("dateTimeStamp",dfDateTimestamp);
//
//		@Getter @Setter
//		private String type;
//		@Getter @Setter
...
//
//		LocalDateTimeFormatterEnum(String type, java.time.format.DateTimeFormatter formatter) {
//			this.type = type;
//			this.formatter = formatter;
//		}
//
//		public static java.time.format.DateTimeFormatter getByTypeWithFormatter(String type){
//			for (LocalDateTimeFormatterEnum cTypeEnum: LocalDateTimeFormatterEnum.values()) {
//				if(cTypeEnum.getType().equals(type)){
//					return cTypeEnum.getFormatter();
//				}
//			}
//			return null;
//		}
