 ...
 */
package com.simbest.cloud.cores.util.office;

import cn.hutool.core.util.StrUtil;
import com.alibaba.nacos.shaded.com.google.common.collect.Maps;
import com.fasterxml.jackson.databind.exc.InvalidFormatException;
import com.simbest.cloud.cores.base.annotations.ExcelVOAttribute;
...
public class ExcelUtil<T> {
    ...
    private void setFieldValue(T entity, String c, Class<?> fieldType, Field field) throws IllegalAccessException {
        if (StringUtils.isNotEmpty(c) && (String.class == fieldType)) {
            ...
            field.set(entity, com.simbest.cloud.cores.util.DateUtil.parseDate(c));
