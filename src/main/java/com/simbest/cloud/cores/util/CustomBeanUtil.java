...
public class CustomBeanUtil extends BeanUtils {
    ...
    public static void copyPropertiesIgnoreNull(Object source, Object target, String... ignoreProperties) {
        String[] strings = ArrayUtils.addAll(ignoreProperties, getNullPropertyNames(source));
    ...
    public static void copyPropertiesIgnoreNullAndId(Object source, Object target) {
        ...
        List<String> ignorePropertyListMerge = new ArrayList<>(ignorePropertyList.size()+1);
