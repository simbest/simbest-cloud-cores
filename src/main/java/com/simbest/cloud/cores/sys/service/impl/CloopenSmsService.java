...
import com.simbest.cloud.cores.utils.http.client.TextBodyRequest;
...
public class CloopenSmsService implements ISimpleSmsService {
    ...
    private boolean sendContents(String phone, String[] contents, String account, String token, String appId, String templateId) {
        ...
        TextBodyRequest textBodyRequest = HttpClient.textBody(baseUrl)
                .header("Authorization", Authorization)
                .header("Accept","application/json")
                .header("Content-Type","application/json;charset=utf-8");
        String result = textBodyRequest.json(jsonPara).asString();
        log.debug(result);
