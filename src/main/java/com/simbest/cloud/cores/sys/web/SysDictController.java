...
import static com.simbest.cloud.orguser.pojo.JsonResponse.SUCCESS_CODE;
import static com.simbest.cloud.orguser.pojo.JsonResponse.MSG_SUCCESS;
...
public class SysDictController extends LogicController<SysDict, String> {
    ...
    @ApiImplicitParams ({@ApiImplicitParam(name = "id", value = "字典类型ID", required = true, dataType = "String", paramType = "query"),
