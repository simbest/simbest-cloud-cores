...
public class AppRuntimeMaster {
     ...
     * @param myPort
     */
    public void makeMeAsMaster(String myHost, Integer myPort){
        masterHost = myHost;
        masterPort = myPort;
     ...
     * @return
     */
    public Map<String, Object> getCurrentMaster(){
        masterHost = RedisUtil.get(ApplicationConstants.MASTER_HOST);
        masterPort = RedisUtil.getBean(ApplicationConstants.MASTER_PORT, Integer.class);
        Map<String, Object> master = Maps.newHashMap();
        master.put("masterHost", masterHost);
        master.put("masterPort", masterPort);
        return master;
    }
