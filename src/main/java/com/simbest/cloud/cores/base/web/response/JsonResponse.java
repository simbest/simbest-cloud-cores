package com.simbest.cloud.cores.base.web.response;
...
public class JsonResponse<T>{
    ...
    public static JsonResponse defaultErrorResponse() {
        JsonResponse jsonResponse = JsonResponse.builder().errcode(ERROR_CODE).message(ErrorCodeConstants.UNKNOW_ERROR)
