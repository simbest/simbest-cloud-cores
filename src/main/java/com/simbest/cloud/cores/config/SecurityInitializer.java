...
import com.simbest.cloud.cores.security.auth.config.ApiSecurityConfigurer;
import com.simbest.cloud.cores.security.auth.config.FormSecurityConfigurer;
import com.simbest.cloud.cores.security.auth.config.MonitorSecurityConfigurer;
